...
## Overview
The SMS Spam Detector is a machine learning model which is designed to analyze text messages and determine whether they are spam or not. It is built using Python and deployed as a simple web application using Streamlit.

## Technology Used
- Python - For programming
- Scikit-learn - For training the model and fine-tune it
